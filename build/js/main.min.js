...
/* harmony import */ var _modules_app__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/app */ "./js/modules/app.js");
...
Object(_modules_app__WEBPACK_IMPORTED_MODULE_3__["initApp"])();
...
var initApp = function initApp() {
  ...
  var newsTypes = document.querySelectorAll('input[name="news"]');
  var newsList = document.querySelector('.news__list');
  var showMoreBtn = document.querySelector('.btn-more');
  var startIndex = 0;
  var newsToShow = 5;
  var restNews;
  var nextComments;
  var apiKey = '8704a4b4a91241cbb6d8eae96cc449660';
  var url = "https://newsapi.org/v2/top-headlines?country=ru&category=sport&apiKey=".concat(apiKey);
  ...
  var showStartInfo = function showStartInfo(arr) {
    var startBtn = document.querySelector('.btn-show');
    var startMessage = document.querySelector('.page-header');
    startMessage.innerHTML = "\u041D\u0430\u0439\u0434\u0435\u043D\u043E ".concat(arr.length, " \u043D\u043E\u0432\u043E\u0441\u0442\u0435\u0439!");
  ...
  var loadNews = function loadNews(arr) {
    var firstNews = array.slice(startIndex, newsToShow);
    firstNews.forEach(function (item) {
      getNews(item);
    });
    markDone();
  ...
  var loadLastNews = function loadLastNews() {
    newsList.innerHTML = '';
    restNews = array.slice(startIndex, newsToShow + startIndex);
    startIndex += newsToShow;
    restNews.forEach(function (item) {
      getNews(item);
    });
    markDone();
  ...
  var getNews = function getNews(obj) {
    var newsTemplate = document.querySelector('#news-item').content.querySelector('.news__item');
    ...
    var date = Date.parse(obj.publishedAt);
    var newsDate = new Date(date);
    newsElement.querySelector('.news__time').textContent = "".concat(newsDate.getHours(), ":").concat(newsDate.getMinutes());
    newsElement.querySelector('.news__year').textContent = "".concat(newsDate.getFullYear(), "-").concat(newsDate.getMonth() + 1, "-").concat(newsDate.getDate());
    newsList.append(newsElement);
  };

  var markDone = function markDone() {
    var doneBtns = document.querySelectorAll('.news__btn');
    doneBtns.forEach(function (item) {
      item.addEventListener('click', function (evt) {
        var newsItem = item.nextElementSibling.classList.toggle('news__link--disabled');
